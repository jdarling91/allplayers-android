...
public class NewAccountActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String birthDateMonth = mDatePicker.getMonth() + "";
    ...
    /**
     * birthdateError().
     * Called if there is an error with the entered birthdate. Will reset the date selector.
     * 
     */
    @SuppressWarnings("deprecation")
    private void birthdateError() {
        mDatePicker.updateDate(Calendar.getInstance().getTime().getYear(),
    ...
    public class GetNewCaptchaTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... arg0) {
            return RestApiV1.createNewUser("", "", "", "", "", "", null, null);
        }
